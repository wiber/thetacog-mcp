...
- Each created systems with **0.3% semantic drift per boundary crossing**
- Drift compounds per crossing, not per calendar day: 365 crossings -- one a day for a year -- leave **33% of the original precision standing** ((0.997)^365 = 0.334). An earlier printing gave 30% annual debt; the book's own formula gives 67%, and the formula is right.
