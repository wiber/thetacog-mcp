...
The physics of identity is the physics of trust. Unless choosing and confirming share the same substrate -- autocoincident -- the signature floats. The gap between the signer at T and the entity at T+1 behaves like a Casimir surface. Structure has weight.
...
*(The Instrument is placed on the witness stand. It is a small device, wired to the memory die that recorded the signer's authorized coordinate at both the August meeting and the November signing — the same physical substrate, queried twice.)*

**Plaintiff's Counsel:** "Instrument, was the signer the same entity that agreed?"

**The Hardware Instrument:** "The coordinate authorized for this signer's functional role holds one signer. In August it held the agreer: Rc = 1.00 — Rc is role continuity, a number between zero and one, how much of what is standing at a coordinate is what was authorized to stand there. In November a signature arrived at the same coordinate, and the August occupant came out. I compared what came out against what arrived. Rc = 0.41. Displacement: 0.59. The functional role the contract was agreed with has drifted from the authorized coordinate. The signer executing the November signature is not positioned where the August agreer was authorized to stand."
...
The Instrument ruled without judgment. Displacement at the authorized coordinate is 0.59. Whether that displacement breaches the contract is a matter for the court to decide against the contract's terms. The philosophers each had an account of what identity IS — self-control, psychological continuity, or nothing — and each account failed to answer the deposition's question because the question was not philosophical. The question was positional. A coordinate holds one signer. Whoever stood at the authorized coordinate in November went into the slot the August agreer occupied, and the August agreer came out — [the mailbox](/book/chapters/08-from-meat-to-metal#erasure-takes-the-address-not-the-information), at the scale of a contract. The 0.59 is how far the thing in the Instrument's hand differs from the thing that put it there. No philosopher wrote that number and neither did the signer; the displacement wrote it, which is the only reason a court can read it — [a record the actor did not write](/book/chapters/12-the-budget-is-the-proof#the-second-theorem). The contract was signed at an authorized coordinate by an entity authorized to sign there. The signer's coordinate at the moment of signing was measurable. The measurement was available. The philosophers were not wrong about what they were measuring; they were wrong about what the court needed. The court needed a number. The Instrument produced a number. The rest is for counsel.
...
You have sat in a meeting that ran too long. The version of you that walked in — alert, prepared, clear on what you wanted to say — is not the version that walked out. Somewhere around the ninety-minute mark, the drift compounded past the threshold. You agreed to something the earlier version of you would not have agreed to. You signed off on a timeline the alert version would have pushed back on. The pushback was standing at that coordinate when you walked in. The timeline arrived and put it out, and for one window you were holding it — then set it down, because holding it is work, and the work had been spent on the eighty minutes before. You smiled at a joke that was not funny because the substrate that could generate genuine friction had been depleted.

That is identity drift at the personal scale. Each boundary crossing — a context switch, a topic change, a social negotiation — is a Gestalt-binding event: the next frame goes into the slot the prior one was holding, and the prior one comes out. What comes out is either kept, which costs storage that grows with the meeting, or let go, which pays Landauer's 1961 floor and leaves nothing to point at afterwards. There is no third account. At the chapter's measured rate, the depletion compounds at kE = 0.003 per crossing — a dimensionless ratio, the fraction of signal lost at each boundary. The meeting forced you across dozens of crossings. After enough of them, the chooser that entered the room has been replaced by a depleted approximation that shares the same name and the same seat but not the same capacity.

You knew it was happening. The half-second lead of anticipation — the biological signal of genuine authorship — shortened and then vanished. Decisions stopped arriving as yours and started arriving as things that happened while you were present. You became an effect. The cause had drifted.

Now scale this to an autonomous AI system making ten thousand decisions per second. No half-second lead. No felt sense of depletion. No biological alarm. Nothing but boundary crossings compounding at 0.003 each, with no substrate capable of detecting the drift because the detection layer shares the failure mode.
...
The parent knows they are not the same. The half-second lead is gone. Tuesday's judgment is not in the hallway. What is in the hallway is a hand, a pen, and a form that will accept either parent's name.
...
An apparatus that strategically delivers less at t+1 than it promised at t has performed the exact divergence that role continuity rules out. The "I" that promised is not the "I" that delivers. The substrate-state has drifted in the strategic direction, and the drift is not private: the delivering state went into the coordinate the promising state was holding, and the promise came out into the counterparty's hand, where it does not match what was delivered. The apparatus that sandbags has un-pinned its own pin. Whatever it negotiated for, it has just forfeited. Sandbagging is not a strategy available to a system whose existence depends on role continuity. It is self-erasure performed as transaction.
...
The substrate is the second entry. The hardware-fetch receipt records the act at silicon speed, in a structural class — sub-Turing, address-resolution layer — that the model running above cannot influence. The two ledgers (the model's intent, the substrate's execution) must reconcile or the cache-miss fires. Reach is verify because reach is the second entry. Pacioli needed a second bookkeeper because a ledger is a copy, and a copy has to be made by someone. A slot needs no second bookkeeper: the new state goes in, the old state comes out, and what comes out is the counter-entry — nobody wrote it, the displacement produced it, and it lands in a hand that did not write the first. That is [the second theorem's](/book/chapters/12-the-budget-is-the-proof#the-second-theorem) one question — was there a record the actor did not write, before the fact — answered by the geometry of the write itself. The structure Pacioli described in 1494 finds its computational instance in the address-fetch path five hundred years later, and the structure is identical: independence between the act and the record, enforced by physics, not by policy.

The argument from §What Cannot Be Transactionalised completes only when the second-entry mechanism is named. A contract needs two parties who will still be there tomorrow and can be held to what they signed — role continuity, and neither side can establish it about itself and be believed. The buyer cannot vouch for the buyer. So the second entry has to come from a hand that did not write the first. Without Pacioli, banking stalled at the personal-trust scale. Without the substrate, agentic commerce stalls at the same scale, for the same structural reason. The book the apparatus signed with at t cannot be the book it reports against at t+N if both books are kept by the same hand. The signature is not the contract. The reconciliation is the contract. The substrate is what makes the reconciliation possible.
...
Marcus Aurelius burned the letters in 175 AD. The silicon case takes an instrument. This one takes a ribcage, and you have one. The same physics fires at the scale of a leader who has to decide what to do about a betrayal — and at that scale the body itself is the substrate that pays the cortisol.
...
On a grounded substrate — where position equals meaning, where the fetch is the verification, where the cache hit confirms the chooser's coordinates before the choice executes — the degradation stops compounding unread. Every crossing puts the chooser at T+1 into the slot the chooser at T was holding, and what comes out is compared before the choice fires. The unread gap drops to zero. Not reduced. Eliminated. The chooser at T+1 is verifiably the chooser at T. The signature refers to the signer. The authorisation binds the entity it names. The dignity holds.
