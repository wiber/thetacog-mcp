...
- Synaptic transmission: 99.7% reliability per spike in the AUDITORY BRAINSTEM (Borst et al. 2012, whose title is *auditory brainstem versus hippocampus*) -- a measured error floor and a ceiling case, not a general synaptic rate
...
2. Calculated average: D-bar ~= 0.3%/day (the original per-day form -- one commit-cadence crossing per day in that dataset, which is how it became 0.3% per crossing)
