...
import { resolvePmuBinary } from './pmu-binary.mjs';   // THE ONE resolver — honours PMU_BINARY, one canonical search (spec v2 Task 2)
...
const PMU_BIN = resolvePmuBinary(REPO_ROOT);
