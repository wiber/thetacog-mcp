...
// atomic (temp-in-same-dir + rename) — see atomic-write.mjs: a plain writeFileSync on this shared
// 12-16MB ledger left it truncated mid-write once already (2026-09-17).
writeJSONAtomic(INTAKE, adj, { indent: 1 });
