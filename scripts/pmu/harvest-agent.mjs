...
if (existsSync(ADJ_PATH)) {
  ...
  // atomic (temp-in-same-dir + rename): a plain writeFileSync on this 12-16MB shared ledger left
  // it truncated mid-write once already (2026-09-17, ten dependent tests down) — see atomic-write.mjs.
  if (!dry) writeJSONAtomic(ADJ_PATH, adj, { indent: 1 });
