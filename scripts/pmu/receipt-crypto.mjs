...
// C97e: the path of the host secret, exported so a guard can assert it is never inside the repo's tracked paths
export const HOST_PRIVATE_KEY_PATH = PRIV_PEM;
