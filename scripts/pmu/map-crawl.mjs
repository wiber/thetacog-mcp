...
for (const repo of surfaces) {
  ...
  rows.push({
    ...
    // C308j: passed straight through from the forker's own tape/dignity-pixel.json — the date
    // THEY minted it, never re-derived here. Absent on any pixel written before this field existed.
    minted_at: pixel && typeof pixel.minted_at === 'string' ? pixel.minted_at : null,
